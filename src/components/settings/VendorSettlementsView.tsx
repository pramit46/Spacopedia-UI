  ...
  return (
    <div className="space-y-8">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <h2 className="text-3xl font-black mb-2 italic tracking-tight uppercase">Vendor Settlements</h2>
          <p className="text-gray-500 dark:text-gray-400 font-medium tracking-tight">Audit trail for contractor disbursements and operational settlements.</p>
        </div>
      </header>
                  ...
                  <tr key={c.id} className="hover:bg-gray-50/50 dark:hover:bg-gray-800/20 transition-all">
                    ...
                    <td className="px-6 py-5">
                      <div className="flex flex-col">
                        <span className="font-bold text-sm tracking-tight">{c.date}</span>
                        <span className="text-[9px] font-black uppercase text-gray-400 tracking-wider font-mono">Fiscal Ref</span>
                      </div>
                    </td>
                    <td className="px-6 py-5">
                    ...
                    <td className="px-6 py-5 text-center">
                      <div className="flex flex-col items-center">
                        <span className="text-xs font-bold text-gray-700 dark:text-gray-300">{c.description}</span>
                        <span className="text-[9px] text-gray-400 font-black uppercase tracking-wider bg-gray-50 dark:bg-gray-800 px-2 py-0.5 rounded-md mt-1">{c.section}</span>
                      </div>
                    </td>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative group overflow-hidden">
                      ...
                      <div className="flex flex-col items-center justify-center p-3 border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-xl bg-gray-50 dark:bg-gray-900 group-hover:bg-gray-100 dark:group-hover:bg-gray-800/50 transition-all">
                        <Upload className="w-4 h-4 text-gray-400 mb-1 group-hover:text-blue-500" />
                        <span className="text-[8px] font-black uppercase text-gray-400 tracking-[0.1em] group-hover:text-blue-500">Log Proof</span>
                      </div>
                    </div>
                  </div>
                </div>
