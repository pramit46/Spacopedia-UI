            ...
            >
              <div className="p-10">
                ...
                <div className="flex gap-4 mt-10">
                  <button className="flex-1 bg-blue-600 text-white py-5 rounded-[2rem] font-black text-xs uppercase tracking-widest shadow-xl shadow-blue-600/20 active:scale-95 transition-all">
                    Start Execution
                  </button>
                  <button 
